# -*- coding: utf-8 -*-
"""
Created on Wed Mar 22 12:37:25 2023
...
DF = pd.read_csv(r'C:\Users\bendr\Box\SDS 384 Project\UTSRP_SelectedTomography_Svensen.csv',skip_blank_lines=True)
...
scaled_data.head()
scaled_data.to_csv('UTSRP_ST_S_scaled.csv')