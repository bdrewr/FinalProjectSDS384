...
df = pd.read_csv(r'C:\Users\bendr\Box\SDS 384 Project\scaled_data_RandomOnly.csv')
df.head()

X_base = df[['specific area','void fraction','L','uG','T Corr','k OH E-3','DCO2 E9','HCO2 E-5','[OH-]']]
Y = df['Fractional Area'].values

X_simple = X_base[['specific area','void fraction','L','uG','T Corr']].values
X_2 = X_base[['specific area','void fraction','L','uG','T Corr','DCO2 E9','HCO2 E-5']].values
...
plt.title('Random Packing Model: Test Dataset Parity Plot, Base Model')
plt.show()
...
plt.xlabel('Actual Values')
plt.ylabel('Predicted Values')
plt.title('Random Packing Model: Train Dataset Parity Plot, Base Model')
plt.show()
...
plt.xlabel('Actual Values')
plt.ylabel('Predicted Values')
plt.title('Random Packing Model: Test Dataset Parity Plot, Best Model')
plt.show()
...
plt.xlabel('Actual Values')
plt.ylabel('Predicted Values')
plt.title('Random Packing Model: Train Dataset Parity Plot, Best Model')
plt.show()
...
plt.xlabel('Actual Values')
plt.ylabel('Predicted Values')
plt.title('Random Packing Model: Test Dataset Parity Plot, Reduced Model')
plt.show()
...
plt.xlabel('Actual Values')
plt.ylabel('Predicted Values')
plt.title('Random Packing Model: Train Dataset Parity Plot, Reduced Model')
plt.show()
...
result_best = permutation_importance(best_model, X_simple, Y, n_repeats=30, random_state=0)
